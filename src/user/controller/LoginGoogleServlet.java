...
public class LoginGoogleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String userId = request.getParameter("userIdGoogle");
		String userPwd = request.getParameter("userPwdGoogle");
		String userName = request.getParameter("userNameGoogle");
		String email = request.getParameter("emailGoogle");
		
		User user = new User(userName, userId+"@google", userId+"@google", email, "", "m", "201900-0000000", "", userId);
